...
<Info>
File size limits may apply based on your subscription plan. Check your account settings for specific limits. [Upgrade your plan]({PRICING_URL}) for higher file size limits and more uploads.
</Info>
